...
import com.example.mvvmretrofitjava.adapter.MoveListAdapter;
import com.example.mvvmretrofitjava.model.MovieModel;
import com.example.mvvmretrofitjava.viewmodel.MovieListViewModel;

import java.util.List;

public class MainActivity extends AppCompatActivity implements MoveListAdapter.ItemClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        adapter = new MoveListAdapter(this, movieModelList, this);
